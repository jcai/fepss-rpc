...
public class LongAwaitRpcApplicationTest {
	@Test
	public void testRpc() throws IOException{
		...
		try{
			...
			Assert.assertEquals(r.getResult(),"get userRequest Data");
			Assert.assertTrue(r.getSuccess());
		}finally{
			application.stop();
		}
